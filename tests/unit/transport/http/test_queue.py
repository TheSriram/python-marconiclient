...
def _response(ids, claim=False):
    if claim:
        ...
        return {
            "messages": [mock_message.message(ids_single) for ids_single in ids],
...
class TestSimpleQueue(unittest.TestCase):
    ...
    def test_get_queue_stats(self):
        ...
        self.conn.get.return_value.json.return_value = json.dumps(
            {'messages': {'free': '14629', 'claimed': '2409'}})
    ...
    def test_queue_delete(self):
        ...
        self.conn.delete.return_value.json.return_value = json.dumps(
            'No Content')
    ...
    def test_queue_claim_messages_id(self):
        ...
        self.conn.get.return_value = mock.MagicMock()
        self.conn.get.return_value.json.return_value = json.dumps(
            _response(ids=['50b68a50d6f5b8c8a7c62b01', '50b68a50d6f5b8c8a7c62b02'], claim=True))
        claimed_messages = self.queue.claim(
            ids=['50b68a50d6f5b8c8a7c62b01', '50b68a50d6f5b8c8a7c62b02'], limit=LIMIT)
        for claimed_message in claimed_messages:
            messagelist.append(claimed_message)
        self.assertEqual(
            messagelist, eval(json.dumps(_response(ids=['50b68a50d6f5b8c8a7c62b01', '50b68a50d6f5b8c8a7c62b02'], claim=True))))
    ...
    def test_queue_get_messages(self):
        ...
        self.conn.get.return_value = mock.MagicMock()
        self.conn.get.return_value.json.return_value = json.dumps(
            _response(ids=['50b68a50d6f5b8c8a7c62b01', '50b68a50d6f5b8c8a7c62b02']))
        messages = self.queue.get_messages()
        messages_body = _response(
            ids=['50b68a50d6f5b8c8a7c62b01', '50b68a50d6f5b8c8a7c62b02'])
        for message in messages:
            messagelist.append(message)
        self.assertEqual(
            messagelist, eval(json.dumps(messages_body['messages'])))

    def test_queue_get_messages_id(self):
        new_URL = '{0}/messages?ids={1},{2}'.format(
            URL, '50b68a50d6f5b8c8a7c62b01', '50b68a50d6f5b8c8a7c62b02')
        messagelist = []
        self.conn.get.return_value = mock.MagicMock()
        self.conn.get.return_value.json.return_value = json.dumps(
            _response(ids=['50b68a50d6f5b8c8a7c62b01', '50b68a50d6f5b8c8a7c62b02'], claim=True))
        messages = self.queue.get_messages(
            ids=['50b68a50d6f5b8c8a7c62b01', '50b68a50d6f5b8c8a7c62b02'])
        messages_body = _response(
            ids=['50b68a50d6f5b8c8a7c62b01', '50b68a50d6f5b8c8a7c62b02'], claim=True)
        for message in messages:
            messagelist.append(message)
    ...
    def test_queue_post_messages(self):
        ...
        self.conn.post.return_value.json.return_value = json.dumps(
            _post_message_response())
    ...
    def test_queue_update_claim(self):
        ...
        self.conn.patch.return_value.json.return_value = json.dumps(
            'No Content')
